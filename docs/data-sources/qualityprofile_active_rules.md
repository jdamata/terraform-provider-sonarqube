...
page_title: "sonarqube_qualityprofile_active_rules Data Source - terraform-provider-sonarqube"
subcategory: ""
description: |-
  Use this data source to list active rules on a Sonarqube quality profile.
---

# sonarqube_qualityprofile_active_rules (Data Source)
...
- `rules` (List of Object) List of active rules for the quality profile. (see [below for nested schema](#nestedatt--rules))
