...
func testAccSonarqubeRuleBasicConfig(rnd string, key string, markdown_description string, name string, template_key string, severity string) string {
	return fmt.Sprintf(`
...
func TestAccSonarqubeRuleBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSonarqubeRuleBasicConfig(rnd, "key", "markdown_description", "name", "xml:XPathCheck", "INFO"),
